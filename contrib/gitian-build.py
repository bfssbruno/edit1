...
def setup():
    ...
    if not os.path.isdir('gitian.sigs.btc'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitcoin-project/gitian.sigs.btc.git'])
    if not os.path.isdir('bitcoin-detached-sigs'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitcoin-project/bitcoin-detached-sigs.git'])
    if not os.path.isdir('gitian-builder'):
        subprocess.check_call(['git', 'clone', 'https://github.com/devrandom/gitian-builder.git'])
    if not os.path.isdir('bitcoin'):
        subprocess.check_call(['git', 'clone', 'https://github.com/bitcoin-project/bitcoin.git'])
...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-linux', '--destination', '../gitian.sigs.btc/', '../bitcoin/contrib/gitian-descriptors/gitian-linux.yml'])
    ...
    if args.windows:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-win-unsigned', '--destination', '../gitian.sigs.btc/', '../bitcoin/contrib/gitian-descriptors/gitian-win.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-osx-unsigned', '--destination', '../gitian.sigs.btc/', '../bitcoin/contrib/gitian-descriptors/gitian-osx.yml'])
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-win-signed', '--destination', '../gitian.sigs.btc/', '../bitcoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-osx-signed', '--destination', '../gitian.sigs.btc/', '../bitcoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def verify():
    ...
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.btc/', '-r', args.version+'-linux', '../bitcoin/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.btc/', '-r', args.version+'-win-unsigned', '../bitcoin/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.btc/', '-r', args.version+'-osx-unsigned', '../bitcoin/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.btc/', '-r', args.version+'-win-signed', '../bitcoin/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.check_call(['bin/gverify', '-v', '-d', '../gitian.sigs.btc/', '-r', args.version+'-osx-signed', '../bitcoin/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/bitcoin-project/bitcoin', help='Specify the URL of the repository. Default is %(default)s')
