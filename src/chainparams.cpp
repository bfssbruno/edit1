...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bitcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.bitcointools.com");
        vSeeds.emplace_back("dnsseed.bitcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitcointools.com");
        vSeeds.emplace_back("seed-b.bitcoin.loshan.co.uk");
