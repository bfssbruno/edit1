Bitcoin Core version 0.17.1 is now available from:
  ...
  <https://download.bitcoin.org/bitcoin-0.17.1/>
...
The default minimum transaction fee `-mintxfee` has been lowered to 0.0001 BTC/kB after relaxing the minimum relay and dust relay fee rates in prior releases. 
...
For backend RPC convenience, the Bitcoin devs have supported to keep the acronym `PSBT`
