Bitcoin Core version 0.16.0 is now available from:
  ...
  <https://download.bitcoin.org/bitcoin-0.16.0/>
...
### BIP173 (Bech32) Address support ("btc1..." addresses)
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("btc1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
...
- #482 `5c8e26d` Bitcoin: Basic changes for v0.16 release (thrasher-)
