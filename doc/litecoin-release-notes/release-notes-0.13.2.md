Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://download.bitcoin.org/bitcoin-0.13.2.1/>
...
Bitcoin Core 0.13.2 will have a strict maximum size on the mempool. The
...
Bitcoin Core 0.13.2 also introduces new default policy limits on the length and
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Bitcoin and Bitcoin Core contributors that may
...
segwit's start date of 1 January 2017 miners can update the Bitcoin
client to Bitcoin Core 0.13.2 to signal for segwit support. When a
